...
<div class="ccm-block-fa-social-media-icons block-<?php echo $bUID ?>">
...
(function($) {
    $( document ).ready( function() {
        var $allButtons = $( '.ccm-block-fa-social-media-icons.block-<?php echo $bUID ?> .svc span' );
        var $bubble = $( '.ccm-block-fa-social-media-icons.block-<?php echo $bUID ?> .speech-bubble' );
