...
{
	case 'my_personal':
		$bubbleText = t('You now have enabled the button to visit my page at "%s". ' .
	...
	case 'my_formal':
		...
		break;
	case 'our_personal':
		$bubbleText = t('You now have enabled the button to visit our page at "%s". ' .
						  'Next time you click at the button the page at "%s" shall be opened. ' .
						  'On opening your personal browser data is transmitted to the provider "%s". ' .
						  'To avoid this you can disable the checkbox at left (and the enabled button).');
		break;
...
?>
		<div class="speech-bubble">
			...
			<label for="bubble-<?php echo $bID ?>"></label>
...
(function($) {
	var $allButtons = $( '.ccm-block-fa-social-media-icons .svc span' );
	var $bubble = $( '.ccm-block-fa-social-media-icons .speech-bubble' );
